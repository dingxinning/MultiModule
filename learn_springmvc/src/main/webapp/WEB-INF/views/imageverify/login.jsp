...
<div class="container">
    <div class="row myCenter">
        <div class="col-xs-6 col-md-4 col-center-block">
            <form class="form-signin" method="post" action="${pageContext.request.contextPath}/image/doLogin">
                <h2 class="form-signin-heading ">请登录<br/>${msg}</h2>
...
//                $("#location").val(value);
        ...
        $("#refresh").click(function(){
            $.ajax({
                url:"${pageContext.request.contextPath}/image/getPng",
